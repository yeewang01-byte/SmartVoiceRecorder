...
PRG="$0"
# Need this for daisy-chaining symlinks. Unfortunately scala.sys.process.Process can't be used here.
while [ -h "$PRG" ] ; do
    ls -ld "$PRG"
...
cd "$SAVED" || exit 1
APP_HOME="$(cd "$(dirname "$SAVED")" && pwd)" || exit 1
